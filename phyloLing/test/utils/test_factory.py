...
def create_test_classes(dataset: TestDataset) -> tuple[type, type, type]:
    ...
    class TestMinimalTreeDistance(unittest.TestCase):
        @unittest.skip
    ...
    return TestTreeDistance, TestDeterminism, TestMinimalTreeDistance
